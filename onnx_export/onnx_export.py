...
from sapiens_inference import SapiensSegmentationType, SapiensNormalType, SapiensDepthType, SapiensPoseEstimationType
...
model_type_dict = {
    ...
    "pose03b": (SapiensPoseEstimationType.POSE_ESTIMATION_03B, TaskType.POSE),
    "pose06b": (SapiensPoseEstimationType.POSE_ESTIMATION_06B, TaskType.POSE),
    "pose1b": (SapiensPoseEstimationType.POSE_ESTIMATION_1B, TaskType.POSE),
}
...
if __name__ == "__main__":
    ...
    export_model(args.model_name, f"{args.model_name}.onnx")
